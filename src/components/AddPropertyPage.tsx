...
export function AddPropertyPage({
  ...
  React.useEffect(() => {
    if (initialValues) {
      ...
      const currentManagerId =
        initialValues.property_managers &&
        initialValues.property_managers.length > 0
      ...
      setFormData((prev) => ({
        ...
        yearBuilt:
          initialValues.yearBuilt != null
            ? String(initialValues.yearBuilt)
            : "",
        totalUnits:
          initialValues.totalUnits != null
            ? String(initialValues.totalUnits)
            : "",
        floors:
          initialValues.floors != null ? String(initialValues.floors) : "",
        totalArea:
          initialValues.totalArea != null
            ? String(initialValues.totalArea)
            : "",
        lotSize:
          initialValues.lotSize != null ? String(initialValues.lotSize) : "",
        parking:
          initialValues.parking != null ? String(initialValues.parking) : "",
        currency: initialValues.currency || prev.currency,
        rentFrequency: (initialValues.features?.nigeria?.rentFrequency ||
          initialValues.features?.rentFrequency ||
          initialValues.rentFrequency ||
          prev.rentFrequency) as "monthly" | "annual",
        avgRent:
          initialValues.avgRent != null ? String(initialValues.avgRent) : "",
        purchasePrice:
          initialValues.purchasePrice != null
            ? String(initialValues.purchasePrice)
            : "",
        currentValue:
          initialValues.currentValue != null
            ? String(initialValues.currentValue)
            : "",
        securityDeposit:
          initialValues.securityDeposit != null
            ? String(initialValues.securityDeposit)
            : "",
        applicationFee:
          initialValues.applicationFee != null
            ? String(initialValues.applicationFee)
            : "",
        cautionFee:
          initialValues.cautionFee != null
            ? String(initialValues.cautionFee)
            : "",
        legalFee:
          initialValues.legalFee != null ? String(initialValues.legalFee) : "",
        agentCommission:
          initialValues.agentCommission != null
            ? String(initialValues.agentCommission)
            : "",
        serviceCharge:
          initialValues.serviceCharge != null
            ? String(initialValues.serviceCharge)
            : "",
        agreementFee:
          initialValues.agreementFee != null
            ? String(initialValues.agreementFee)
            : "",
        managerId:
          (initialValues.property_managers &&
            initialValues.property_managers.find((pm: any) => pm.isActive)
              ?.managerId) ||
          currentManagerId,
        features: Array.isArray(initialValues.features)
          ? initialValues.features
          : [],
        unitFeatures: Array.isArray(initialValues.unitFeatures)
          ? initialValues.unitFeatures
          : [],
        insuranceProvider: initialValues.insuranceProvider || "",
        insurancePolicyNumber: initialValues.insurancePolicyNumber || "",
        insurancePremium:
          initialValues.insurancePremium != null
            ? String(initialValues.insurancePremium)
            : "",
        insuranceExpiration: initialValues.insuranceExpiration
          ? String(initialValues.insuranceExpiration).slice(0, 10)
          : "",
        propertyTaxes:
          initialValues.propertyTaxes != null
            ? String(initialValues.propertyTaxes)
            : "",
        description: initialValues.description || "",
        notes: initialValues.notes || "",
        coverImage:
          initialValues.coverImage ||
          (Array.isArray(initialValues.images) && initialValues.images[0]) ||
          "",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Insurance and legal info",
    },
  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      ...
      case 2:
        ...
        if (parseInt(formData.totalUnits) <= 0)
        ...
        break;
      case 3:
        if (!formData.avgRent.trim())
          newErrors.avgRent = "Average rent is required";
        break;
      case 4:
  ...
  const handleCreateManager = async () => {
    ...
    else if (!/\S+@\S+\.\S+/.test(newManagerForm.email))
    ...
    try {
      ...
      if ((response as any).data?.tempPassword) {
        toast.info(
          `Temporary password: ${(response as any).data.tempPassword}`,
          { duration: 10000 }
        );
      }
    } catch (error: any) {
    ...
    if (validateStep(currentStep)) {
      ...
      if (mode === "add" && propertyLimit !== undefined) {
        if (currentPropertyCount >= propertyLimit) {
          toast.error(
            `Property limit reached. Your plan allows ${propertyLimit} properties. Please upgrade your plan to add more properties.`
          );
          return;
        }
      }
      ...
      if (mode === "add" && unitLimit !== undefined && unitLimit > 0) {
        ...
        if (newTotalUnits > unitLimit) {
          const remainingUnits = Math.max(0, unitLimit - currentUnitCount);
          toast.error(
            `Unit limit exceeded. Your plan allows ${unitLimit} total units. You currently have ${currentUnitCount} units and can only add ${remainingUnits} more. Please upgrade your plan.`
          );
          return;
        }
      }
      ...
      const propertyData = {
        ...
        // Store rentFrequency in features.nigeria.rentFrequency (similar to units)
        // Note: formData.features is an array of amenity IDs, but property.features is a JSON object
        // We need to preserve the array for amenities while adding rentFrequency to the JSON structure
        features: {
          amenities: Array.isArray(formData.features) ? formData.features : [],
          nigeria: {
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Upload a cover image for your property
                  </p>
                </div>
              </div>
              <ImageUpload
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Enter the physical details of your property
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      G+1, G+2, etc. (Ground + additional floors)
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Year the property was completed
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Total floor area in square meters or square feet
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Total land area (e.g., 600sqm, 1200sqm)
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Available parking slots for tenants
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Set rental rates and additional charges
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  All financial values will be in this currency
                </p>
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("rentFrequency", value)
                  }
                >
                  <SelectTrigger className="border-gray-300 focus:border-[#7C3AED] focus:ring-[#7C3AED]">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  How often rent is collected for this property
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  <Label
                    ...
                    className="text-sm font-semibold text-gray-700"
                  >
                    {formData.rentFrequency === "annual" ? "Annual" : "Monthly"}{" "}
                    Rent per Unit *
                  </Label>
                  <Input
                    id="avgRent"
                    ...
                    onChange={(e) =>
                      handleInputChange("avgRent", e.target.value)
                    }
                    placeholder={
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Covers maintenance, security, waste management
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("agreementFee", e.target.value)
                    }
                    placeholder="Tenancy agreement fee"
                    className="border-gray-300 focus:border-[#7C3AED] focus:ring-[#7C3AED]"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    One-time tenancy agreement processing
                  </p>
                </div>
            ...
            <div>
              <div className="flex items-center mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Select all features available at the property level
                  </p>
                </div>
              </div>
              ...
              {formData.features.length > 0 && (
                <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-xl">
                  <p className="text-sm font-semibold text-[#7C3AED]">
                    ...
                    {formData.features.length === 1 ? "feature" : "features"}{" "}
                    selected
                  </p>
                </div>
              )}
            ...
            <div>
              <div className="flex items-center mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Select features available in individual units
                  </p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {formData.unitFeatures.length > 0 && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl">
                  <p className="text-sm font-semibold text-green-700">
                    {formData.unitFeatures.length}{" "}
                    {formData.unitFeatures.length === 1
                      ? "feature"
                      : "features"}{" "}
                    selected
                  </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Property insurance and coverage details
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("insurancePremium", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {formData.insuranceExpiration ? (
                            format(
                              new Date(formData.insuranceExpiration),
                              "PPP"
                            )
                          ) : (
                      ...
                      <PopoverContent
                        className="w-auto p-0 bg-white border-gray-300 rounded-xl shadow-xl"
                        align="start"
                      >
                        {/* Calendar Header */}
                        <div className="bg-gradient-to-r from-[#7C3AED] to-[#5B21B6] px-4 py-3 rounded-t-xl">
                          <p className="text-white font-semibold text-sm">
                            Select Policy Expiration Date
                          </p>
                        </div>
                        {/* Calendar Body */}
                        <div className="p-3 bg-white">
                          <CalendarComponent
                            ...
                            classNames={{
                              ...
                              nav_button:
                                "h-8 w-8 bg-transparent p-0 opacity-70 hover:opacity-100 border border-gray-300 rounded-lg hover:bg-purple-50 hover:border-[#7C3AED] hover:text-[#7C3AED] transition-colors",
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Property tax and legal compliance details
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("propertyTaxes", e.target.value)
                    }
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Property description and internal notes
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 border-2 border-purple-200 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-700">
                Please review all the information below before submitting. You
              ...
              <Card className="border-2 border-purple-200 shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3 pt-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900">
                      {formData.lotSize ? `${formData.lotSize} sq ft` : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600 font-medium">
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-wrap gap-2">
                    {formData.unitFeatures.map((featureId) => {
                      const feature = unitFeatures.find(
                        (f) => f.id === featureId
                      );
                      return feature ? (
                        <Badge
                ...
                <Card className="border-2 border-blue-200 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-3 pt-6">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900">
                        {formData.insuranceProvider || "N/A"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 font-medium">
                      ...
                      <span className="font-semibold text-gray-900">
                        {formData.insurancePolicyNumber || "N/A"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 font-medium">
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            if (target.parentNode) {
                              ...
                              errorDiv.innerHTML =
                                '<div class="text-center">📷<br/>Error</div>';
      ...
      {mode === "add" && propertyLimit !== undefined && (
        <div className="bg-gray-50 border-b px-4 sm:px-6 lg:px-8 py-3">
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
            ...
            {(currentPropertyCount >= propertyLimit ||
              (unitLimit && currentUnitCount >= unitLimit)) && (
                  ...
                  <div className="relative mt-1.5">
                    <Input
                      ...
                      className={`pl-10 h-11 rounded-xl border-gray-200 focus:border-[#7C3AED] focus:ring-[#7C3AED] ${
                        managerFormErrors.name ? "border-red-400 bg-red-50" : ""
                      }`}
                    />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-purple-700 leading-relaxed">
                    ...
                    manager's email. They can change it on their first login.
                  </p>
                </div>
              </div>
            </div>
