...
export function CareersPage({
  ...
  // Mock job openings - will be replaced with backend data
  const jobOpenings = [
    {
      id: 1,
      ...
      remote: 'Hybrid',
      experience: 'Senior',
      description: 'Build scalable features for our property management platform using React, Node.js, and PostgreSQL.',
    ...
    },
    {
      ...
      description: 'Design intuitive user experiences for property managers and tenants across web and mobile platforms.',
    ...
    },
    {
      ...
      remote: 'Remote',
      experience: 'Mid-level',
      description: 'Help property management companies succeed with Contrezz through onboarding, training, and ongoing support.',
      requirements: ['2+ years in SaaS', 'Property management knowledge', 'Excellent communication'],
      salary: '$80k - $110k'
    },
    {
      id: 4,
      ...
      requirements: ['4+ years experience', 'AWS/GCP', 'Docker/Kubernetes', 'Terraform'],
      salary: '$140k - $180k'
    },
    {
      id: 5,
      ...
      description: 'Generate qualified leads and schedule demos for our sales team in the property management space.',
      requirements: ['1+ years in sales', 'Strong communication', 'Self-motivated'],
    ...
    },
    {
      ...
      remote: 'Remote',
      experience: 'Mid-level',
      description: 'Create compelling content that educates property managers and drives organic growth.',
      requirements: ['3+ years in content marketing', 'SEO knowledge', 'B2B SaaS experience'],
      salary: '$90k - $120k'
    },
    {
      id: 7,
      ...
      remote: 'Hybrid',
      experience: 'Mid-level',
      description: 'Design and implement robust APIs and backend services for our property management platform.',
      requirements: ['3+ years experience', 'Node.js/Python', 'Database design', 'API development'],
      salary: '$130k - $170k'
    },
    {
      id: 8,
      ...
      remote: 'Hybrid',
      experience: 'Senior',
      description: 'Define product strategy and roadmap for our tenant management features.',
      requirements: ['5+ years in product', 'B2B SaaS', 'Data-driven', 'Stakeholder management'],
      salary: '$140k - $180k'
    }
  ];
  ...
  const departments = [
    ...
    { id: 'Sales', name: 'Sales', count: jobOpenings.filter(j => j.department === 'Sales').length },
    { id: 'Marketing', name: 'Marketing', count: jobOpenings.filter(j => j.department === 'Marketing').length },
    { id: 'Customer Success', name: 'Customer Success', count: jobOpenings.filter(j => j.department === 'Customer Success').length }
  ];
  ...
  const benefits = [
    ...
    },
    {
      icon: Coffee,
      title: 'Office Perks',
      description: 'Free meals, snacks, and drinks in our modern, collaborative spaces',
      color: 'yellow'
    }
  ];
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
            Join a passionate team that's transforming how properties are managed. We're looking for talented individuals who want to make a real impact.
          </p>
              ...
              <div className="flex flex-wrap gap-2">
                {departments.map((dept) => (
                  <Button
                    ...
                    size="sm"
                    className={selectedDepartment === dept.id ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white' : ''}
                    onClick={() => setSelectedDepartment(dept.id)}
                  >
                    {dept.name}
                    <Badge variant="secondary" className="ml-2">{dept.count}</Badge>
                  </Button>
                ))}
              </div>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {locations.map((loc) => (
                  <Button
                    ...
                    size="sm"
                    className={selectedLocation === loc.id ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white' : ''}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div className={`h-14 w-14 bg-gradient-to-br ${getColorClasses(benefit.color)} rounded-xl flex items-center justify-center mb-4 shadow-lg`}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_100%] animate-gradient">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            We're always looking for talented people. Send us your resume and tell us why you'd be a great fit for Contrezz.
          </p>
          <Button
            size="lg"
            variant="secondary"
