                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <UITooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>Total funding received for this project during the selected period. Includes client payments, loans, equity investments, grants, and other funding sources.</p>
                      </TooltipContent>
                    </UITooltip>
                  </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <UITooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>Total expenses paid for this project during the selected period. Includes labor, materials, equipment, permits, professional fees, and other costs.</p>
                      </TooltipContent>
                    </UITooltip>
                  </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <UITooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>Net cash flow for the selected period. Calculated as Total Inflow minus Total Outflow. Positive values indicate more funding received than expenses paid.</p>
                      </TooltipContent>
                    </UITooltip>
                  </div>
                  <p
